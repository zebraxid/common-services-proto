...
func (_m *InAppNotificationService) ReadMessage(ctx context.Context, in *commonproto.ReadMessageRequest, opts ...client.CallOption) (*commonproto.InAppNotifResponse, error) {
	...
	var r0 *commonproto.InAppNotifResponse
	if rf, ok := ret.Get(0).(func(context.Context, *commonproto.ReadMessageRequest, ...client.CallOption) *commonproto.InAppNotifResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonproto.InAppNotifResponse)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *commonproto.ReadMessageRequest, ...client.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
