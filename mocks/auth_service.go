...
// RequestSSOState provides a mock function with given fields: ctx, in, opts
func (_m *AuthService) RequestSSOState(ctx context.Context, in *commonproto.CoreRequest, opts ...client.CallOption) (*commonproto.Response, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *commonproto.Response
	if rf, ok := ret.Get(0).(func(context.Context, *commonproto.CoreRequest, ...client.CallOption) *commonproto.Response); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonproto.Response)
...
// ValidateSSOState provides a mock function with given fields: ctx, in, opts
func (_m *AuthService) ValidateSSOState(ctx context.Context, in *commonproto.CoreRequest, opts ...client.CallOption) (*commonproto.Response, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
